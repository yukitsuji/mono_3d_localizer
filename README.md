# Monocular 3D localization and detection using 3D Prior map

## Requirement
・3D Semantic Maps
・Pretrained 2D Object Detector
・KITTI Loader for tracking dataset
・KITTI Loader for raw dataset
・KITTI Loader for odometry dataset
・ORB SLAM module for scan matching
・Ground Plane Estimation module
